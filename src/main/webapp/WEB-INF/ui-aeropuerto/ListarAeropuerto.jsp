...
<div class="conteiner-table">
	<div class="boton">
	    <a href="AeropuertoServlet?accion=redirecAgregarAeropuerto"><button>Agregar Aeropuerto</button></a>
	</div> 
	<table role="grid">
	  <thead>
	    <tr>
	        ...
	        <th scope="col">Descripción Aeropuerto</th>
	  ...
	  <tbody>
	     <%if(listaAeropuertos == null || listaAeropuertos.isEmpty()){%>
	  		<tr>
	  			<td>No hay aeropuertos disponibles</td></tr>
  		 <%}else{ %>
