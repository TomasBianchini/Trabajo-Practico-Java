...
<div class="mensaje">
	...
	<div class="conteiner-table">
		 <div class="boton">
		    <a href="CiudadServlet?accion=redirecAgregarCiudad"><button>Agregar Ciudad</button></a>
		</div> 
		<table role="grid">
		  <thead>
		    <tr>
